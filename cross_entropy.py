...
Cross entropy is a loss function for softmaxed outputs
"""
...
def cross_entropy(actual, predicted):
    return -np.sum(actual * np.log(predicted))  # / float(predicted.shape[0])
...
# SAME IN PYTORCH
loss = nn.CrossEntropyLoss()  # includes softmax layer
